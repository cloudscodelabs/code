...
class WorkflowManager {
  createFromTemplate(
    ...
    const parallelGroups = this.computeParallelGroups(template.steps);
  ...
  computeParallelGroups(steps: WorkflowTemplateStep[]): string[][] {
    // BFS level-order grouping by dependency graph
